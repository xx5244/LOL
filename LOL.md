...
+ ## 葛雷夫(男槍)
  ...
  + ### NOTE
        ...
        W-Q
        沒牆就用煙霧彈輔助Q的命中
        因為W的煙霧彈除了遮蔽敵方視野野外還有緩速效果
        所以W丟敵人，Q丟敵人後面

        A-Q-E
        先A敵人一發後，立馬QE上去，最好是Q能反彈牆的時候用
...
+ ## 阿璃(狐狸)
  ...
  + ### NOTE
        ...
        Q出去是AP傷，回來是真傷
        所以Q回來的傷害比較重要
        如果Q末端命中敵人，那基本上來回都容易命中
        反之，如果Q前段就命中敵人，那敵人會有時間走位不被回來的Q打中

        W也會有遞減的移速
        W攻擊的優先順序
        被E中的敵人 > A的英雄 > 最近的英雄 > 殘血小兵 > 最近的小兵

        可利用R技能位移拉動回來的Q命中

        連招
        A-W-A
        A到敵方英雄，往前搭配W給的移速，再A第二下，配合W攻擊優先順序觸發電刑

        A-W-Q
        跟上面的差不多意思，只是更安全

        E-Q-W-A
        E中一定要先放Q，這樣才容易打滿Q來回的傷害
...
+ ## 趙信
  ...
  + ### NOTE
        ...
        P: 每第三次攻擊會有額外傷害跟回復生命
        Q: 接下來三次A都有額外傷害，第三次還會擊飛效果
        Q能減其它技能CD
        W: 突刺造成緩速+傷害，被擊中的英雄會被挑戰(頭上會有顯示)
        如果敵人站在一直線上，那最後一個W到的就是最尾端的敵人
        E: 衝向敵人+緩速+傷害+攻速
        如先用W刺中，則E的距離可變長
        R: 橫掃周圍，擊退未被挑戰的敵人
        被挑戰只有一個，最後一下A的敵人或者是最後一下W到的敵人，頭上都會顯示
...
+ ## 姬亞娜
  ...
  + ### NOTE
        ...
        P: 普攻或技能會有額外傷害，獲得元素會重置被動
        Q: 普通就是丟圓弧小範圍的AOE傷害
        草: 隱身+移速，隱身約2~3秒，所以不要跑太出去poke，不然容易回不來
        土: 對於半血以下的敵人會有額外傷害
        冰: 暫時定身+緩速
        W: 向前衝刺，可獲得元素
        其實不一定要走進草裡，可以看圈圈範圍
        ...
        看元素之形buff會比較準
        E: 穿透敵人造成傷害，不能當純位移使用
        R: 擊退敵人，如果推到牆上，會有暈眩+爆炸
        從ARAM中線往兩旁推就可以了，但也要注意敵方站位
...
+ ## 克雷德
  ...
  + ### NOTE
        ...
        P: 小嘎會幫忙承受傷害，小嘎生命歸零會跑走
        沒小嘎後，可攻擊英雄、小兵、建築來增加勇氣，滿了小嘎就回來
        有小嘎Q: 丟出捕獸夾緊咬敵人
        沒小嘎Q: 散彈射擊並後退
        W: 反正都是被動，加攻速，第四下最痛
        E: 有兩段，加速衝刺可穿過敵人，第二段(有3秒時間按)是會自動跟蹤第一段中的敵人
        R: 衝刺+護盾+傷害+撞到敵人造成擊退效果
        R途中路線中有敵人也可以轉方向撞上去
...
+ ## 劫(影流之主)
  ...
  + ### NOTE
        ...
        P: 對生命值低於50%的敵人有額外傷害
        Q: 本身與分身都會丟出手里劍
        W: 影分身向前衝刺，再次施放會與分身位置交換
        E: 本身與分身同時發動斬擊
        R: 無法指定並衝向一名敵人，原位置留分身，重新施放能回去原位置

        連招
        W-E-Q
        基本上就是丟W分身到敵方身邊，按下EQ造成傷害

        雪球-W-雪球-E-W
        雪球命中敵人後，把W放在安全位置，雪球過去按E後馬上按W回來
        但W有距離限制的，太遠會回不來喔
...
+ ## 薇可絲
  ...
  + ### NOTE
        ...
        P: 下次技能會擊倒+恐懼敵人，對無望的敵人普攻會有額外傷害
        藍條下面會有一條被動條，滿了就是被動好了
        Q: 一條波，一條線上的敵人都會受到傷害，如果是有被動就會集體被恐懼
        前寬後窄、前慢後快
        會消耗標記
        W: 周圍波，自身獲得護盾，周圍敵人受傷害
        會消耗標記
        E: 施放圓形波，造成傷害+緩速敵人
        會附加標記
        R: 一條波，命中第一個敵人造成傷害，再次施放會移動到該敵人身邊造成二次傷害
        可穿小兵，不會被小兵阻擋
